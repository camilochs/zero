...
Blockly.Python.addReservedWords(
    ...
    'and,as,assert,break,end,class,go,continue,def,del,elif,else,except,exec,finally,for,from,global,if,import,in,is,lambda,not,or,pass,print,raise,return,try,while,with,yield,' +
